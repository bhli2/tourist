...
public class RedisUtils {
    ...
    private static RedisTemplate<String,Object> rest;
    ...
    public static boolean expire( String key, long time) {
        return rest.expire(key, time, TimeUnit.SECONDS);
    }
    ...
    public static long getTime(String key) {
        return rest.getExpire(key, TimeUnit.SECONDS);
    }
    ...
    public static boolean persist(String key) {
        return rest.boundValueOps(key).persist();
    }
    ...
    public static Object get(String key) {
        return key == null ? null : rest.opsForValue().get(key);
    }
    ...
    public static void set(String key, Object value) {
        rest.opsForValue().set(key, value);
    }
    ...
    public static void set(String key, Object value, long time) {
        if (time > 0) {
            rest.opsForValue().set(key, value, time, TimeUnit.SECONDS);
        } else {
            rest.opsForValue().set(key, value);
        }
    }
    ...
    public static void batchSet(Map<String, String> keyAndValue) {
        rest.opsForValue().multiSet(keyAndValue);
    }
    ...
    public static void batchSetIfAbsent(Map<String, String> keyAndValue) {
        rest.opsForValue().multiSetIfAbsent(keyAndValue);
    }
    ...
    public static Long increment(String key, long number) {
        return rest.opsForValue().increment(key, number);
    }
    ...
    public static Set<Object> members(String key) {
        return rest.opsForSet().members(key);
    }
    ...
    public static void randomMembers(String key, long count) {
        rest.opsForSet().randomMembers(key, count);
    }
    ...
    public static Object randomMember(String key) {
        return rest.opsForSet().randomMember(key);
    }
    ...
    public static Object pop(String key) {
        return rest.opsForSet().pop("setValue");
    }
    ...
    public static long size(String key) {
        return rest.opsForSet().size(key);
    }
    ...
    public static boolean sHasKey(String key, Object value) {
        return rest.opsForSet().isMember(key, value);
    }
    ...
    public static boolean isMember(String key, Object obj) {
        return rest.opsForSet().isMember(key, obj);
    }
    ...
    public static boolean move(String key, String value, String destKey) {
        return rest.opsForSet().move(key, value, destKey);
    }
    ...
    public static void remove(String key, Object... values) {
        rest.opsForSet().remove(key, values);
    }
    ...
    public static Set<Object> difference(String key, String destKey) {
        return rest.opsForSet().difference(key, destKey);
    }
    ...
    public static void add(String key, Map<String, String> map) {
        rest.opsForHash().putAll(key, map);
    }
    ...
    public static Map<Object, Object> getHashEntries(String key) {
        return rest.opsForHash().entries(key);
    }
    ...
    public static boolean hashKey(String key, String hashKey) {
        return rest.opsForHash().hasKey(key, hashKey);
    }
    ...
    public static String getMapString(String key, String key2) {
        return rest.opsForHash().get("map1", "key1").toString();
    }
    ...
    public static Integer getMapInt(String key, String key2) {
        return (Integer) rest.opsForHash().get("map1", "key1");
    }
    ...
    public static String popValue(String key) {
        return rest.opsForSet().pop(key).toString();
    }
    ...
    public static Long delete(String key, String... hashKeys) {
        return rest.opsForHash().delete(key, hashKeys);
    }
    ...
    public static Long increment(String key, String hashKey, long number) {
        return rest.opsForHash().increment(key, hashKey, number);
    }
    ...
    public static Set<Object> hashKeys(String key) {
        return rest.opsForHash().keys(key);
    }
    ...
    public static Long hashSize(String key) {
        return rest.opsForHash().size(key);
    }
    ...
    public static void leftPush(String key, Object value) {
        rest.opsForList().leftPush(key, value);
    }
    ...
    public static Object index(String key, long index) {
        return rest.opsForList().index("list", 1);
    }
    ...
    public static List<Object> range(String key, long start, long end) {
        return rest.opsForList().range(key, start, end);
    }
    ...
    public static void leftPush(String key, String pivot, String value) {
        rest.opsForList().leftPush(key, pivot, value);
    }
...
//        rest.opsForList().leftPushAll(key,"w","x","y");
        rest.opsForList().leftPushAll(key, values);
    }
    ...
    public static void leftPushAll(String key, String value) {
        rest.opsForList().rightPush(key, value);
    }
...
//        rest.opsForList().leftPushAll(key,"w","x","y");
        rest.opsForList().rightPushAll(key, values);
    }
     ...
     * @return
     */
    public static <T> void rightPushAll(String key, Collection<T> values) {
        rest.opsForList().rightPushAll(key, values);
    }
    ...
    public static void rightPushIfPresent(String key, Object value) {
        rest.opsForList().rightPushIfPresent(key, value);
    }
    ...
    public static long listLength(String key) {
        return rest.opsForList().size(key);
    }
    ...
    public static void leftPop(String key, long timeout, TimeUnit unit) {
        rest.opsForList().leftPop(key, timeout, unit);
    }
    ...
    public static void rightPop(String key, long timeout, TimeUnit unit) {
        rest.opsForList().rightPop(key, timeout, unit);
    }
}
