 ...
 * 图片做圆角处理
 */
public class GeneratedAvatarUtil {
    public static void main(String[] args) throws IOException {
        String name = "布宜诺斯艾利斯博卡";
        String outPath = "C:\\Users\\86186\\Desktop\\mm\\"+ name +".png";
        generateImg(name, outPath);
    }
    /**
     * 绘制字体头像
     * 如果是英文名，只显示首字母大写
     ...
     */
    public static void generateImg(String name, String outPath)
            throws IOException {
        int width = 100;
        int height = 100;
        ...
        //生成图片
        ImageIO.write(rounded, format, file);
    }
    /**
     * 判断字符串是否为中文
     */
