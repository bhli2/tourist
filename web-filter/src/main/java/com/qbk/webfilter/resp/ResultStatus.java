...
public enum ResultStatus {
    ...
    /*证书冻结接口描述*/
    FROZEN_CERT_NOTNULL(1001,"身份证号、移动终端手机号参数不能同时为空"),
    FROZEN_CERT_NOTEXISTS(1002,"证书不存在，无法进行冻结操作"),
    FROZEN_CERT_FROZENED(1003,"证书已是被冻结状态"),
    FROZEN_CERT_FAIL_LIST(1004,"未成功证书列表"),
    FROZEN_CERT_NO_RESPONSE(1005,"调用未成功")
