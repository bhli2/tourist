...
public class AESUtil {
     ...
     * 盐
     */
    private static final String SLATKEY = "qbk";

    public static void main(String[] args) throws Exception {
        String encrypt = encrypt("测试加密");
        System.out.println(encrypt);

        String decrypt = decrypt("Ps78NhGRo+81x53k5xnbVQ==");
        System.out.println(decrypt);

        String decrypt2 = decrypt("emaSLCICbQGs3OE2v97f6w==");
